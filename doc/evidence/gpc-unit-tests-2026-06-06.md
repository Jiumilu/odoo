...
test_mark_adds_error_when_provided (test_gpc_tools.CoreFlowSmokeTests.test_mark_adds_error_when_provided) ... ok
test_run_orm_smoke_reports_flow_failures (test_gpc_tools.CoreFlowSmokeTests.test_run_orm_smoke_reports_flow_failures) ... ok
test_run_orm_smoke_reports_missing_modules_without_database_writes (test_gpc_tools.CoreFlowSmokeTests.test_run_orm_smoke_reports_missing_modules_without_database_writes) ... ok
...
| `tools/gpc_core_flow_smoke.py` | 缺失模块、业务块失败、权限失败等边界分支 | 防止异常路径被误判为通过 |
