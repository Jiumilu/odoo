...
export class ErrorDialog extends Component {
    ...
    static title = _t("GlobalCloud GPC Error");
...
ClientErrorDialog.title = _t("GlobalCloud GPC Client Error");

// -----------------------------------------------------------------------------
// Network Error Dialog
// -----------------------------------------------------------------------------
export class NetworkErrorDialog extends ErrorDialog {}
NetworkErrorDialog.title = _t("GlobalCloud GPC Network Error");
...
export class RPCErrorDialog extends ErrorDialog {
    ...
    inferTitle() {
        ...
        switch (this.props.type) {
            case "server":
                this.title = _t("GlobalCloud GPC Server Error");
                break;
            case "script":
                this.title = _t("GlobalCloud GPC Client Error");
                break;
            case "network":
                this.title = _t("GlobalCloud GPC Network Error");
                break;
        }
    }
...
export class WarningDialog extends Component {
    ...
    inferTitle() {
        ...
        return this.props.title || _t("GlobalCloud GPC Warning");
    }
}
...
export class RedirectWarningDialog extends Component {
    ...
    setup() {
        ...
        this.title = capitalize(subType) || _t("GlobalCloud GPC Warning");
        this.message = message;
